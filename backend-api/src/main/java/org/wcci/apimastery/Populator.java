...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        album2.addComment(new Comment("Ben's Life is this album",5));
        albumRepo.save(album2);
        Song BillieJean = new Song("BillieJean", "4:15",5, album2,"https://open.spotify.com/embed/track/3S2R0EVwBSAVMd5UMgKTL0?utm_source=generator");
        ...
        album3.addComment(new Comment("Adnan's Life is this album",4));
        albumRepo.save(album3);
        Song Starboy = new Song("Starboy", "3:15", 3,album3,"https://open.spotify.com/embed/track/7MXVkk9YMctZqd1Srtv4MB?utm_source=generator");
        ...
        album4.addComment(new Comment("Brian's life is this comment",3));
        ...
        album6.addComment(new Comment("Ricky's Life is this album",4));
