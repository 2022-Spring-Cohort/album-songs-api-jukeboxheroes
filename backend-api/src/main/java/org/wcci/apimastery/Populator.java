...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        JukeBoxHero.addComment(new Comment("Lastly, Ben the wife smuggler made this object caps to, RIP to the crew",3));
        ...
        album2.addComment(new Comment("Adnan's Life is this album",1));
        ...
        BillieJean.addComment(new Comment("Poor Brian made this object capital, RIP his java chances",5));
        ...
        album3.addComment(new Comment("Ryan's Life is this album",1));
        ...
        Starboy.addComment(new Comment("This song is an object and shouldnt be capital, but Adnan is on the team.",4));
        ...
        album4.addComment(new Comment("comment",4));
        ...
        doSomethin.addComment(new Comment("Never really Heard it!",3));
